...
void LCD_DrawRectangle( int x0, int y0, int x1, int y1 , uint16_t color)
{
	int i, j;	
...
void LCD_DrawObstacle(int x, int y, uint16_t color)
{
	LCD_DrawRectangle(x, y, x+80, y+24, color);
}

void LCD_DrawHeader(int x, int y, uint16_t color)
{
	LCD_DrawRectangle(x, y, 320, y+20, color);
}

void LCD_DrawSquare(int x, int y, uint16_t color)
{
	LCD_DrawRectangle(x, y, x+20, y+20, color); //draws square 
}
...
void LCD_draw_smile( int x0, int y0, int radius, uint16_t color)
{
  int x = radius, y = 0;
  int xChange = 1 - (radius << 1);
  int yChange = 0;
...
{
  // you must write your code here;
	LCD_draw_circle(x0, y0, radius, color);
	LCD_draw_circle(x0 - 10, y0 - 10, radius/8, color);
	LCD_draw_circle(x0 + 10, y0 - 10, radius/8, color);
	LCD_draw_circle_full(x0 + 10, y0 - 10, radius/8, color);
	LCD_draw_smile(x0, y0 + 5, radius/2, color);
}
